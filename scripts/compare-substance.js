...
const modelsMatch = dataContent.match(
  /export const READWISE_MODELS: MentalModel\[\] = \[([\s\S]*?)\n\];/
);
...
const mismatches = [
  {
    code: '6C',
    oldName: "Kahneman's 8 Decision-Making Questions",
    newName: 'Mental Accounting & Reference Point Dependence',
  },
  {
    code: '6D',
    oldName: 'Mental Accounting & Reference Point Dependence',
    newName: 'Social Psychology & Environmental Influence',
  },
  {
    code: '6E',
    oldName: 'Social Psychology & Environmental Influence',
    newName: "Kahneman's 8 Decision-Making Questions",
  },
  {
    code: '13B',
    oldName: 'Social Reality Construction & Collective Belief',
    newName: 'Social Identity & Group Belonging',
  },
  {
    code: '14B',
    oldName: 'Semantics vs. Meaning & Deep Understanding',
    newName: 'Communication Bandwidth & Medium Constraints',
  },
  {
    code: '15C',
    oldName: 'Predictive Processing & Constructed Experience',
    newName: 'Media as Reality Constructor',
  },
  {
    code: '18A',
    oldName: 'Love as Nuclear Fuel & Life Foundation',
    newName: 'Quality vs. Quantity in Relationships',
  },
  {
    code: '18D',
    oldName: 'Compounding Human Connections',
    newName: 'Attachment & Interdependence',
  },
  {
    code: '19C',
    oldName: 'Physiological States & Decision Quality',
    newName: 'Sleep, Nutrition, & Movement as Foundation',
  },
  {
    code: '20B',
    oldName: 'Mind-Body Integration & Embodied Presence',
    newName: 'Acceptance vs. Resistance',
  },
  {
    code: '20C',
    oldName: 'Deconstructing Mental Patterns & Pain Body',
    newName: 'Meditation & Contemplative Practice',
  },
  {
    code: '20D',
    oldName: 'Transcending Ego & Two-Selves Integration',
    newName: 'Non-Attachment & Letting Go',
  },
];
...
function compareDescriptions(oldDesc, newDesc) {
  if (!oldDesc || !newDesc || oldDesc.length < 20 || newDesc.length < 20)
    return 0;
...
for (const mismatch of mismatches) {
  ...
  const prinSimilarity = compareDescriptions(
    oldContent.principles,
    newContent.principles
  );
  const avgSimilarity = (descSimilarity + prinSimilarity) / 2;

  const matchStatus =
    avgSimilarity > 0.3 ? '✅ SAME SUBSTANCE' : '❌ DIFFERENT MODEL';
  ...
  console.log(
    `   NEW Description: ${newContent.description.substring(0, 150)}...`
  );
