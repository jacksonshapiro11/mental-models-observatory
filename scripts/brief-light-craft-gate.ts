 ...
 * 1,450-1,750 length target (advisory HERE; enforcement lives in
...
function main(): number {
  ...
  // (target 1,450-1,750, hard 1,900, blocking only under --enforce-length).
  ...
  // These are the smoke detector that found the Feb→Jul regression: mean sentence length 15.4→26.5
