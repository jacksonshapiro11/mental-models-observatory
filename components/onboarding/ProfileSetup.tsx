            ...
            <div className='space-y-6'>
              ...
              <div className='space-y-3'>
                {[
                  {
                    value: 'new',
                    label: 'New to mental models',
                    desc: "I'm just getting started",
                  },
                  {
                    value: 'some',
                    label: 'Some experience',
                    desc: 'I know a few frameworks',
                  },
                  {
                    value: 'experienced',
            ...
            <div className='space-y-6'>
              ...
              <div className='grid grid-cols-2 gap-3'>
                {interestOptions.map(interest => {
                  ...
                  const Icon =
                    typeof interest.icon === 'string' ? null : interest.icon;
                    ...
                    >
                      <div className='text-2xl mb-2'>
                        {Icon ? (
                          ...
                          <span>{String(interest.icon)}</span>
                        )}
                      </div>
                ...
                {[
                  {
                    ...
                    desc: 'Expand my knowledge and thinking',
                  },
                  {
                    value: 'work',
                    label: 'Professional Development',
                    desc: 'Improve my work performance',
                  },
                  {
                    value: 'curiosity',
                    label: 'Pure Curiosity',
                    desc: 'Explore interesting ideas',
                  },
                  {
                    value: 'teaching',
                    label: 'Teaching Others',
                    desc: 'Share knowledge with others',
                  },
                ].map(option => (
                  <button
                    key={option.value}
                  ...
                  {[
                    ...
                    <button
                      ...
                      onClick={() =>
                        setProfile({
                          ...profile,
                          preferredDifficulty: option.value as any,
                        })
                      }
            ...
            <div className='flex space-x-3'>
              ...
              {step < 4 ? (
                ...
                <button
                  ...
                  disabled={
                    !profile.timeAvailable || !profile.preferredDifficulty
                  }
                  className='btn btn-primary'
                >
                  Complete Setup
