...
export default function PersonalizedGuide({
  ...
  useEffect(() => {
    ...
    if (userProfile) {
      const paths = UserProfileManager.getRecommendedPaths(
        userProfile,
        userBehavior
      );
      ...
      <div className='bg-gradient-to-br from-foundational-50 to-accent-50 rounded-xl p-8 border border-foundational-200'>
        <div className='text-center'>
          ...
          <p className='text-neutral-600 mb-6 max-w-md mx-auto'>
            Answer a few quick questions to get mental model recommendations
          ...
          <div className='mt-6 pt-6 border-t border-foundational-200'>
            <p className='text-sm text-neutral-500 mb-4'>
              Or explore these popular starting points:
            </p>
        ...
        <div>
          ...
          <p className='text-neutral-600'>
            ...
            {profile.interests.length > 2 &&
              ` and ${profile.interests.length - 2} more`}
          </p>
        </div>
