          ...
          <div className="flex items-center gap-3 px-4 py-3">
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              <a
                ...
                className="p-2 rounded-md text-[#1DB954] hover:opacity-80 hover:bg-neutral-100 dark:hover:bg-ct-dark transition-all"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-md text-[#D56DFB] hover:opacity-80 hover:bg-neutral-100 dark:hover:bg-ct-dark transition-all"
              ...
              <div className="relative">
                <button
                  onClick={copyRssUrl}
                  className="p-2 rounded-md text-neutral-400 dark:text-neutral-500 hover:text-amber-500 dark:hover:text-ct-yellow hover:bg-neutral-100 dark:hover:bg-ct-dark transition-colors"
