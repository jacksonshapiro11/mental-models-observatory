...
} from '@/lib/intelligent-personalization';
import {
  ArrowRight,
  Brain,
  Clock,
...
export default function IntelligentResultsPage({
  profile,
}: IntelligentResultsPageProps) {
  ...
  useEffect(() => {
    ...
    const learningAnalysis =
      IntelligentPersonalizationEngine.analyzeUserLearningProfile(
        initialBehavior
      );
    setLearningProfile(learningAnalysis);

    // Generate adaptive paths
    const paths = IntelligentPersonalizationEngine.generateAdaptivePaths(
      profile,
      initialBehavior
    );
        ...
        <div className='text-center mb-12'>
          ...
          <div className='max-w-3xl mx-auto'>
            <p className='text-xl text-neutral-600 mb-4'>
              Based on your {profile.intelligentFlags.learningStyle} learning
              style and interest in{' '}
            ...
            {profile.intelligentFlags.setupBehavior && (
              <p className='text-lg text-neutral-500'>
                Your {profile.intelligentFlags.setupBehavior.deliberationStyle}{' '}
                approach to setup suggests you'll appreciate our{' '}
                {learningProfile?.preferredComplexity} learning progression.
              </p>
            )}
          </div>
        </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
            <div className='text-center p-4 bg-foundational-50 rounded-lg'>
              <div className='h-12 w-12 rounded-full bg-foundational-100 flex items-center justify-center mx-auto mb-3'>
                {React.createElement(getGoalIcon(profile.goals), {
                  className: 'h-6 w-6 text-foundational-600',
                })}
              </div>
            ...
            <div className='text-center p-4 bg-accent-50 rounded-lg'>
              ...
              <p className='font-semibold text-neutral-800 capitalize'>
                {profile.intelligentFlags.challengePreference ||
            ...
            <div className='flex flex-wrap gap-3'>
              {profile.interests.map((interest, index) => {
                ...
                return (
                  <div
                    key={interest}
                    className='flex items-center space-x-2 bg-neutral-100 px-4 py-2 rounded-full'
                  >
                    ...
                    {index === 0 && (
                      <span className='text-xs bg-foundational-100 text-foundational-700 px-2 py-1 rounded'>
                        Primary
                      </span>
                    )}
                  </div>
        ...
        <div className='mb-8'>
          <div className='text-center mb-8'>
            ...
            <p className='text-lg text-neutral-600 max-w-2xl mx-auto'>
              These paths evolve based on your progress, interests, and learning
              patterns. Each one is uniquely crafted for your learning DNA.
            </p>
          </div>
            ...
            {adaptivePaths.map((path, index) => (
              ...
              >
                ...
                <div className='p-6 bg-gradient-to-r from-foundational-500 to-foundational-600 text-white'>
                  ...
                  <p className='text-foundational-100 text-sm'>
                    {path.description}
                  </p>
                </div>
                ...
                <div className='p-4 bg-foundational-50 border-b'>
                  <div className='flex items-start space-x-3'>
                    ...
                    <div>
                      ...
                      <p className='text-sm text-foundational-700'>
                  ...
                  <div className='mb-6 p-3 bg-accent-50 rounded-lg'>
                    ...
                    <div className='flex flex-wrap gap-2'>
                      <span className='text-xs bg-accent-100 text-accent-700 px-2 py-1 rounded'>
                        {path.adaptiveFeatures.difficultyProgression}{' '}
                        progression
                      </span>
                      ...
                      {path.adaptiveFeatures.reinforcementTriggers.length >
                        0 && (
                        <span className='text-xs bg-accent-100 text-accent-700 px-2 py-1 rounded'>
                          Auto reinforcement
                        </span>
        ...
        <div className='bg-white rounded-xl shadow-lg p-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            ...
            >
              ...
              <p className='text-sm text-neutral-600'>
                Explore our complete collection of 119 mental models
              </p>
            </Link>
            ...
            >
              ...
              <p className='text-sm text-neutral-600'>
                Discover knowledge organized by 40 domains
              </p>
            </Link>
