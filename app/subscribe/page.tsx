...
export const metadata: Metadata = {
  ...
  description:
    'Get the daily intelligence brief every morning. Markets, geopolitics, AI, crypto, and macro — filtered through mental models. 8 minutes. Free.',
  alternates: { canonical: '/subscribe' },
  openGraph: {
    title: 'Subscribe to Cosmic Trex',
    description:
      'Daily financial intelligence brief. Markets, meditations, and mental models. Every morning. 8 minutes. Free.',
    url: '/subscribe',
  },
};
          ...
          <div className='space-y-8'>
            <div className='border-l-[3px] border-ct-yellow pl-6'>
              ...
              <p className='text-text-secondary leading-relaxed'>
                Markets, crypto, commodities, rates — not just prices but
                positioning, flows, and the signals beneath the surface that
                tell you where smart money is moving.
              </p>
            </div>
            <div className='border-l-[3px] border-ct-pink pl-6'>
              ...
              <p className='text-text-secondary leading-relaxed'>
                Deep analysis that connects today's data to bigger patterns. The
                Take goes where headline-driven newsletters won't.
              </p>
            </div>
            <div className='border-l-[3px] border-ct-green-disc pl-6'>
              ...
              <p className='text-text-secondary leading-relaxed'>
                Cross-domain insights from physics, psychology, game theory, and
                systems thinking. The frameworks behind the frameworks.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className='bg-white py-16 sm:py-20 border-t border-[#e8e8e4]'>
        <div className='mx-auto max-w-2xl px-4 sm:px-6'>
          ...
          <p className='text-text-primary text-lg leading-relaxed text-center mb-6'>
            50+ expert sources checked daily — Lyn Alden, Byrne Hobart,
            SemiAnalysis, Simon Willison, and dozens more. Theses tracked with
            explicit predictions and outcomes.
          </p>
          <p className='text-text-secondary text-base leading-relaxed text-center italic'>
            ...
            humanity and the world remain the same." We're drowning in content
