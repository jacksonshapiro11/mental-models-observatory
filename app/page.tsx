...
export default function HomePage() {
  ...
  const dataLayerCards = (signalData?.signals ?? [])
    .slice(0, 2)
    .map(signal => ({
      domain: signal.domain.toUpperCase(),
      title: signal.terminalLine,
      body:
        signal.text.length > 180
            ...
            <div>
              ...
              <div className='font-mono text-sm text-ct-green-data space-y-4'>
                <div className='text-text-on-dark'>
                  <span className='text-ct-green-data'>&gt;</span> cosmic_trex
                  --status
                </div>
                ...
                <div className='border-t border-ct-green-data pt-6 mt-6'>
                  <div className='text-ct-green-data mb-2 font-mono text-sm'>
                    SIGNAL DETECTED
                  </div>
                  ...
                  {signalData?.updatedAt && (
                    <div className='text-[#333] mt-3 text-[9px] font-mono'>
                      signals:{' '}
                      {new Date(signalData.updatedAt).toLocaleDateString()} ·
                      prices: live
                    </div>
                  )}
                </div>
          ...
          <div className='bg-ct-yellow p-6 sm:p-8 lg:p-12 flex flex-col justify-center'>
            <div>
              ...
              <h1 className='font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-ct-dark leading-tight mb-4'>
                {signalData?.headline ||
                  "Your morning briefing is rewritten headlines. This isn't."}
              </h1>

              <p className='font-body text-base sm:text-lg text-ct-dark leading-relaxed mb-8 max-w-lg'>
                {signalData?.tldr ||
                  'Markets, meditations, and mental models. Delivered every morning, cross-domain thinking in 8 minutes.'}
              </p>
              ...
              <div className='mb-8 space-y-2'>
                ...
                <p className='font-mono text-xs text-ct-dark/70'>
                  ~10 minutes · essential market signals
                </p>
                <div className='pt-2'>
                  <Link
                    href='/daily-update'
          ...
          <div className='bg-ct-dark p-6 sm:p-8 lg:p-12'>
            ...
            <div className='space-y-6'>
              {dataLayerCards.map((card, idx) => (
                <div
                  key={idx}
                  className='bg-surface-dark-card border border-ct-green-data/30 p-6 rounded-sm'
                >
        ...
        <div className='mx-auto max-w-6xl px-4 sm:px-6 lg:px-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8'>
            ...
            <div className='bg-surface-dark-card border border-ct-green-data/30 p-8 rounded-sm'>
              <div className='text-3xl font-serif font-bold text-ct-green-data mb-4'>
                01
              </div>
              <h3 className='font-serif text-xl font-bold text-white mb-2'>
                The Brief
              ...
              <p className='font-body text-sm text-text-on-dark-muted leading-relaxed mb-6'>
                Markets. Meditations. Mental models. Delivered every morning,
                cross-domain thinking in 8 minutes.
              </p>
              <div className='font-mono text-xs text-ct-green-data'>
            ...
            <div className='bg-surface-dark-card border border-ct-yellow/30 p-8 rounded-sm'>
              <div className='text-3xl font-serif font-bold text-ct-yellow mb-4'>
                02
              </div>
              <h3 className='font-serif text-xl font-bold text-white mb-2'>
                The Observatory
              ...
              <p className='font-body text-sm text-text-on-dark-muted leading-relaxed mb-6'>
                Explore {modelCount} mental models across {domainCount}{' '}
                knowledge domains. Build mental scaffolding.
              </p>
              <div className='font-mono text-xs text-ct-yellow'>
                {modelCount} models / {domainCount} domains
              </div>
            </div>

            {/* 03: The Library */}
            <div className='bg-surface-dark-card border border-ct-pink/30 p-8 rounded-sm'>
              <div className='text-3xl font-serif font-bold text-ct-pink mb-4'>
                03
              </div>
              <h3 className='font-serif text-xl font-bold text-white mb-2'>
                The Library
              ...
              <p className='font-body text-sm text-text-on-dark-muted leading-relaxed mb-6'>
                1,000+ hand-curated sources. 150+ books, 175+ articles, 600+
                podcasts. The research behind every model.
              </p>
              <div className='font-mono text-xs text-ct-pink'>
                1,000+ sources
              </div>
            </div>
          </div>
        ...
        <div className='mx-auto max-w-6xl px-4 sm:px-6 lg:px-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
            {domainBreakdown.map((domain, idx) => (
              <div
                key={idx}
                className='bg-white border-2 border-ct-dark p-6 rounded-sm'
              >
        ...
        <div className='mx-auto max-w-6xl px-4 sm:px-6 lg:px-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-8'>
            {archiveTakes.map((take, idx) => (
              <div
                key={idx}
                className='bg-surface-take border border-ct-dark/10 p-6 rounded-sm'
              >
                <div className='inline-block bg-ct-pink text-white px-2 py-1 text-xs font-mono font-semibold mb-3 rounded-sm'>
                  THE TAKE
                </div>
