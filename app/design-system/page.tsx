        ...
        <Stack gap='2xl'>
          ...
          <Section padding='lg' background='foundational'>
            <Stack gap='md' align='center'>
              ...
              >
                Complete design system showcase for the Mental Models
                Observatory
              </Text>
            </Stack>
          </Section>
          ...
          <Section padding='lg' background='neutral'>
            <Stack gap='md' align='center'>
              <Text
                ...
                className='text-center text-neutral-600'
              >
                This design system provides consistent, accessible, and
                beautiful components for the Mental Models Observatory.
              </Text>
              <Cluster gap='sm'>
