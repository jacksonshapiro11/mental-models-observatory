import {
  ...
  getAllWeeklySlugs,
  getWeeklyBySlug,
} from '@/lib/daily-update-parser';
import {
  getAllWeeklyLightSlugs,
  getWeeklyLightBySlug,
} from '@/lib/weekly-light-parser';
import {
  getAllBriefLightDates,
  getBriefLightByDate,
} from '@/lib/brief-light-parser';
...
export const metadata: Metadata = {
  ...
  description:
    'Every published edition of the Cosmic Trex daily intelligence brief — full briefs and super briefs. Markets, meditations, and mental models, published daily since February 2026.',
  alternates: { canonical: '/archive' },
  openGraph: {
    title: 'Daily Brief Archive — Cosmic Trex',
    description:
      'Every published edition of the Cosmic Trex daily intelligence brief.',
    url: '/archive',
  },
};
    ...
    <div className='min-h-screen bg-surface-reading'>
        ...
        <div className='px-4 sm:px-6 lg:px-8 py-12'>
          <div className='max-w-4xl mx-auto'>
            ...
            <p className='text-text-on-dark text-sm mb-6'>
              Every published edition of Markets, Meditations &amp; Mental
              Models
            </p>
            <p className='text-text-on-dark-muted text-xs font-mono'>
              {briefs.length}+ full briefs · {superBriefs.length}+ super briefs
              · {weeklyBriefs.length}+ weeklies | Published daily since February
              2026
            </p>
          </div>
        </div>
      ...
      <div className='px-4 sm:px-6 lg:px-8 py-8'>
        <div className='max-w-4xl mx-auto'>
          <ArchiveClient
            briefs={briefs}
            superBriefs={superBriefs}
            weeklyBriefs={weeklyBriefs}
            weeklyLightBriefs={weeklyLightBriefs}
          />
        </div>
      </div>
    </div>
