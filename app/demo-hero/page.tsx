    ...
    <div className='min-h-screen'>
      ...
      <section className='container-content py-4xl'>
        <div className='max-w-4xl mx-auto'>
          <h2 className='text-h1 text-neutral-900 mb-lg'>
            Espresso-Gold Theme Usage
          </h2>
            ...
            <div className='card p-xl'>
              ...
              <div className='space-y-md'>
                <div className='flex items-center gap-md'>
                  <div
                    className='w-16 h-16 rounded-medium'
                    style={{ backgroundColor: 'var(--espresso-h1)' }}
                  ></div>
                  <div>
                    <p className='font-mono text-body-small text-neutral-700'>
                      --espresso-h1
                    </p>
                ...
                <div className='flex items-center gap-md'>
                  <div
                    className='w-16 h-16 rounded-medium'
                    style={{ backgroundColor: 'var(--espresso-body)' }}
                  ></div>
                  <div>
                    <p className='font-mono text-body-small text-neutral-700'>
                      --espresso-body
                ...
                <div className='flex items-center gap-md'>
                  <div
                    className='w-16 h-16 rounded-medium'
                    style={{ backgroundColor: 'var(--espresso-accent)' }}
                  ></div>
                  <div>
                    <p className='font-mono text-body-small text-neutral-700'>
                      --espresso-accent
                ...
                <div className='flex items-center gap-md'>
                  <div
                    className='w-16 h-16 rounded-medium'
                    style={{ backgroundColor: 'var(--espresso-cta-bg)' }}
                  ></div>
                  <div>
                    <p className='font-mono text-body-small text-neutral-700'>
                      --espresso-cta-bg
                    ...
                    <p className='text-caption text-neutral-500'>
                      #D4AF37 • CTA background
                    </p>
                  </div>
                </div>
                <div className='flex items-center gap-md'>
                  <div
                    className='w-16 h-16 rounded-medium border border-neutral-300'
                    style={{ backgroundColor: 'var(--espresso-cta-text)' }}
                  ></div>
                  <div>
                    <p className='font-mono text-body-small text-neutral-700'>
                      --espresso-cta-text
...
/>`}
                ...
                <div>
                  <h4 className='text-h4 text-neutral-800 mb-sm'>
                    With Custom Content
                  </h4>
                  <pre className='bg-neutral-100 p-md rounded-medium overflow-x-auto text-body-small'>
                    {`<HeroEspresso
      ...
      Custom Content
                ...
                <div>
                  ...
                  <ul className='list-disc list-inside space-y-sm text-body-small text-neutral-700'>
                    <li>
                      <code className='bg-neutral-100 px-sm py-xs rounded'>
                        bg-espresso-gold
                      </code>{' '}
                      - Layered gradient background with grain
                    </li>
                    <li>
                      <code className='bg-neutral-100 px-sm py-xs rounded'>
            ...
            <div className='card p-xl'>
              <h3 className='text-h3 text-neutral-900 mb-md'>
                Design Principles
              </h3>
              <ul className='space-y-md text-body text-neutral-700'>
                <li className='flex gap-md'>
                  ...
                  <span>
                    <strong>High Contrast:</strong> Light text on dark
                ...
                <li className='flex gap-md'>
                  <span className='text-accent-500'>✓</span>
                  <span>
                    <strong>Layered Gradients:</strong> Creates depth without
                ...
                <li className='flex gap-md'>
                  <span className='text-accent-500'>✓</span>
                  <span>
                    <strong>Subtle Texture:</strong> Grain overlay adds
                ...
                <li className='flex gap-md'>
                  <span className='text-accent-500'>✓</span>
                  <span>
                    <strong>Golden Accents:</strong> Warm gold (#D4AF37) creates
                    premium feel
                  </span>
                </li>
                <li className='flex gap-md'>
                  <span className='text-accent-500'>✓</span>
                  <span>
                    <strong>Accessible:</strong> All text meets WCAG AA contrast
                    requirements
                  </span>
                </li>
              </ul>
