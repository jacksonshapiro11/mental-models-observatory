              ...
              <Card variant='elevated' padding='lg'>
                <Stack gap='lg'>
                  ...
                  <div>
                    ...
                    <Text variant='body'>
                      Body - Standard paragraph text for most content
                    </Text>
                ...
                <Stack gap='lg'>
                  ...
                  <div>
                    ...
                    <Grid cols={2} gap='lg'>
                      ...
                      <div>
                        <Text variant='body-small' className='mb-md'>
                          Horizontal Cluster:
                        </Text>
                        <Cluster gap='sm'>
                          <Badge>Tag 1</Badge>
              ...
              <Card variant='elevated' padding='lg'>
                <Stack gap='lg'>
                  ...
                  <div>
                    ...
                    <Stack gap='md'>
                      <Alert type='info' title='Information'>
                        This is an informational alert with some helpful
                        content.
                      </Alert>
                  ...
                  <div>
                    ...
                    <Stack gap='md'>
                      <div>
                        <Text variant='body-small' className='mb-sm'>
                          Variants:
                        </Text>
                        <Cluster gap='sm'>
          ...
          <Section padding='lg' background='neutral'>
            <Stack gap='md' align='center'>
              <Text
                ...
                className='text-center text-neutral-600'
              >
                This showcase demonstrates all UI components with their
