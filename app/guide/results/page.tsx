...
function ResultsContent() {
  ...
  const [profile, setProfile] = useState<
    (UserProfile & { personalContext: any }) | null
  >(null);
  ...
  useEffect(() => {
    ...
    if (userProfile) {
      ...
      let updatedProfile = userProfile as UserProfile & {
        personalContext: any;
      };
  ...
  if (!profile) {
    return (
      <div className='min-h-screen bg-gradient-to-br from-foundational-50 via-neutral-25 to-accent-50 dark:from-[var(--espresso-bg-dark)] dark:via-[var(--espresso-bg-medium)] dark:to-[var(--espresso-bg-light)] flex items-center justify-center transition-colors duration-300'>
        <div className='text-center'>
          <h1 className='text-2xl font-bold text-neutral-800 dark:text-[var(--espresso-h1)] mb-4'>
            No Profile Found
          </h1>
          <p className='text-neutral-600 dark:text-[var(--espresso-body)] mb-6'>
