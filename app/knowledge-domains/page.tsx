      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='mt-4 text-xl text-gray-600 max-w-3xl mx-auto'>
            Explore mental models organized by domain of knowledge. Each domain
            contains carefully curated frameworks and thinking tools.
          </p>
        </div>
        ...
        <div className='mt-16 text-center'>
          <div className='inline-flex items-center space-x-8 bg-white rounded-lg px-8 py-4 shadow-sm'>
            ...
            <div>
              <div className='text-2xl font-bold text-gray-900'>
                {allDomains.reduce(
                  (acc, domain) => acc + (domain.models?.length || 0),
                  0
                )}
              </div>
