...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title: `${domain.name} — Cosmic Trex Observatory`,
      description,
      url: `/knowledge-domains/${slug}`,
    },
  };
}
      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12'>
        ...
        <div className='bg-gray-50 rounded-lg p-8'>
          ...
          <p className='text-gray-600 mb-6'>
            {domain.description} This collection of mental models provides
            frameworks for understanding and working within this domain
            effectively.
          </p>
