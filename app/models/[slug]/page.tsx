  ...
  return allModels
    ...
    .map(m => ({
      ...
      relevance:
        ...
        (m.tags || []).filter((t: string) => currentTags.includes(t)).length *
          2,
      ...
      <section className='bg-ct-yellow px-4 py-4 border-b-[3px] border-ct-dark'>
        <div className='max-w-2xl mx-auto'>
          ...
          {relatedModels.map((rm: any) => (
            ...
            >
              <div className='text-[9px] uppercase tracking-wider text-[#888] mb-0.5'>
                {rm.domain}
              </div>
              <div className='text-[13px] font-medium text-ct-dark mb-0.5'>
                {rm.name}
              </div>
