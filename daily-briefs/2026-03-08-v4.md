...
| Russell 2000 | 2,525 | -2.33% | -2.4% | — | — | — | — | — |

*S&P broke below the 50D/200D convergence zone (~6,900-6,924). Death cross resolved to the downside. Dow turned negative for 2026. Only energy green. VIX ~28 — underpricing Monday gap risk given weekend oil facility strikes. Next support: 200D MA ~6,575.*

### Crypto (March 8 — Live)
| Asset | Price | 1D | 7D | 1M | ATH | Dist. | 50D MA | 200D EMA | 200W MA |
|-------|-------|-----|-----|------|-----|-------|--------|----------|---------|
| BTC | $67,271 | +7% bounce | -2% | -21% | $126,000 | -47% | ~$75,800 | ~$96,100 | ~$42,000 |
| ETH | $1,965 | +6% bounce | — | -30% | $4,878 | -60% | ~$2,800 | ~$3,570 | ~$2,200 |
| SOL | $83 | -1.2% | +2.9% | -31% | $295 | -72% | ~$185 | ~$155 | ~$65 |
...
*BTC at $67-69K weekend range. F&G 12 — every prior instance preceded 12-month returns of +158% to +1,400%. Whale accumulation of 270K BTC ($18.7B) is the strongest contrarian signal. ETF inflows held 6 days ($1.9B) then reversed Friday. Lyn Alden: BTC > Gold for next 2-3 years on sentiment divergence.*
...
DXY: 98.87 (-0.45%) | CME FedWatch: 94.1% hold March 18, earliest cut June (~47%) | Fed funds: 3.50-3.75%

*WTI's 35% weekly gain is the largest since futures trading began in 1983. 10Y at 4.17% and rising into equity weakness — the Yield Regime Classification (yields up on risk-off = inflation fear > safety bid) has been active for a full week. Gold consolidating at $5,100-5,200 after $5,400 war spike — Reserve Ratchet (sovereign buyers absorb dips, establishing progressively higher floors) holding as predicted.*
