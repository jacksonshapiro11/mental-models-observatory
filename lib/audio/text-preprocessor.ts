...
const SECTION_INSTRUCTIONS: Record<string, string> = {
  ...
  'The Dashboard': 'Quick market snapshot — 2-3 sentences max. What was the session\'s character (risk-on, risk-off, rotational), the key technical picture, and one structural observation if there is one. Do NOT preview stories from The Six or summarize news — just the numbers and what they\'re saying. Plain language, no jargon.',
  'The Take': 'This is the heart of the episode — the big picture argument. Give it full treatment, don\'t compress. Let the argument build naturally, like you\'re thinking through it in real time. Explain any frameworks in plain language — if the listener has never heard of the concept, they should still follow the logic.',
  'The Model': 'Explain the model in plain language. What is it, where does it come from, and how does it connect to what\'s happening today? Make it feel like you\'re sharing something genuinely interesting you learned — not lecturing.',
  'The Big Stories': 'Run through the big stories. Cover EVERY story individually — headline, context, why it matters, what to watch. React to them naturally. Flag which ones you think matter most. Don\'t repeat information that was already covered in The Six — reference it briefly and add the NEW context.',
  "Tomorrow's Headlines": 'Cover EVERY headline. For each: what happened, what it means going forward, and the signal. Keep it forward-looking. Don\'t re-explain things already covered — just add the new angle.',
  'The Watchlist': 'Talk through each position like you\'re explaining your thinking to a friend. The asset, why it\'s interesting, the key levels, and what would make you wrong. Plain language — no spreadsheet jargon.',
  'Discovery': 'This is an original essay about a concept from science, history, or systems thinking — NOT a reading recommendation. Explain the concept, tell the story, and help the listener see why it matters. Teach it like you find it genuinely fascinating. Do NOT say "this is a great read" or refer to it as something to read — it\'s content you\'re delivering right now. Keep it warm and intellectually curious.',

  // The Six sub-sections — each gets its own API call to prevent compression
  'The Six: Markets & Macro': 'Cover EVERY bullet point. Weave a narrative — what\'s the thread connecting these stories? Use plain language. If there\'s a technical concept, explain it simply. React naturally to the surprising ones.',
  'The Six: Crypto': 'Cover EVERY bullet. Explain each in plain terms — the data, the thesis, and what it means for someone holding crypto. Connect the dots where stories relate. Avoid crypto jargon where a normal word works.',
  'The Six: AI & Tech': 'Cover EVERY bullet. Explain what shipped, what changed, and why it matters. If something is genuinely exciting, let that come through naturally — don\'t perform excitement with hype words.',
  'The Six: Geopolitics': 'Cover EVERY bullet. Explain the developments and why they matter for markets. Help the listener understand the strategic picture. Use plain language — "Iran is expanding its targets from oil infrastructure to civilian airports" not "the escalation matrix is broadening."',
  'The Six: Deep Read / Listen': 'Share each recommendation like you\'re texting a friend a link. Why is this worth their time? What will they learn? Keep it genuine — no hard sell.',
  'The Six: Inner Game': 'Read this warmly and slowly. Include the quote, the teaching, and the practical action. This is the human moment — let it breathe. Don\'t rush it. No market references here at all.',
};
