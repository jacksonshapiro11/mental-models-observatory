...
import type { Domain, MentalModel } from './data.ts';
...
export const READWISE_DOMAINS: Domain[] = [
  ...
  },
  {
    ...
    models: ['energy-resource-flows-3a', 'energy-resource-flows-3b'],
    tier: 1,
    icon: '⚡',
    color: '#F59E0B',
    createdAt: '2025-08-25T18:25:18.308Z',
  ...
  },
  {
    ...
    models: ['evolution-biology-25a', 'evolution-biology-25b'],
    tier: 3,
    icon: '🧬',
    color: '#10B981',
    createdAt: '2025-08-25T18:25:18.309Z',
  ...
  },
  {
    ...
    models: ['creativity-innovation-26a', 'creativity-innovation-26b'],
    tier: 3,
    icon: '🎨',
    color: '#8B5CF6',
    createdAt: '2025-08-25T18:25:18.309Z',
  ...
  },
  {
    ...
    models: ['mathematics-logic-27a', 'mathematics-logic-27b'],
    tier: 3,
    icon: '🔢',
    color: '#F59E0B',
  ...
  },
  {
    ...
    models: ['engineering-design-29a', 'engineering-design-29b'],
    tier: 3,
    icon: '⚙️',
    color: '#EC4899',
    createdAt: '2025-08-25T18:25:18.310Z',
  ...
  },
  {
    ...
    models: ['complex-adaptive-systems-30a', 'complex-adaptive-systems-30b'],
    tier: 3,
    icon: '🔗',
    color: '#06B6D4',
    createdAt: '2025-08-25T18:25:18.310Z',
  ...
  },
  {
    ...
    models: ['statistics-data-science-31a', 'statistics-data-science-31b'],
    tier: 3,
    icon: '📊',
    color: '#84CC16',
    createdAt: '2025-08-25T18:25:18.310Z',
  ...
  },
  {
    ...
    models: ['economics-market-dynamics-35a', 'economics-market-dynamics-35b'],
    tier: 4,
    icon: '📊',
    color: '#A855F7',
    createdAt: '2025-08-25T18:25:18.310Z',
  ...
  },
  {
    ...
    models: ['ritual-meaning-making-37a', 'ritual-meaning-making-37b'],
    tier: 4,
    icon: '🕯️',
    color: '#10B981',
    createdAt: '2025-08-25T18:25:18.310Z',
...
export const READWISE_MODELS: MentalModel[] = [
  ...
  },
  {
    ...
    tags: ['energy', 'information', 'consciousness'],
    difficulty: 'advanced',
    createdAt: '2025-08-25T18:25:18.308Z',
    updatedAt: '2025-08-25T18:25:18.308Z',
  },
  ...
  },
  {
    ...
    description:
      "Living systems obey strict scaling laws determined by metabolic energy requirements. Kleiber's Law shows that metabolic rate scales to the 3/4 power of body mass—a mouse's metabolism per unit mass is far higher than an elephant's. These constraints explain why animals have size limits, why cities scale differently than organisms, and why energy efficiency changes with scale.",
  ...
  },
  {
    ...
    tags: ['systems', 'behavior', 'interaction'],
    difficulty: 'advanced',
    createdAt: '2025-08-25T18:25:18.308Z',
    updatedAt: '2025-08-25T18:25:18.308Z',
  },
  ...
  },
  {
    ...
    description:
      'Building understanding from fundamental truths rather than by analogy or convention. First principles thinking breaks down complex problems to their basic elements, then constructs solutions from there. This approach is harder than reasoning by analogy but produces genuine innovation rather than incremental improvement.',
  ...
  },
  {
    ...
    description:
      'Technology as extension of human cognition operates within physical and energetic constraints. Tech moves so fast that it changes the world—tech moving forward is a law of life. Investing heavily in tech creates opportunities across industries. Currently computing, biology, energy, and manufacturing are undergoing exponential change, creating massive leverage points.',
  ...
  },
  {
    ...
    description:
      "The mind-body connection isn't metaphor—it's physiology. Your left ear (non-dominant) is the emotional ear; your right ear (dominant) is the logic ear. Focus on the inner energy field of your body to achieve present-moment clarity. Fear neutralizes love and can turn off other feelings like a switch through physiological mechanisms, not just psychological ones.",
  ...
  },
  {
    ...
    description:
      'Innovation is the productization of discovery. New ideas rarely emerge from nowhere—they result from combining existing elements in novel ways. Knowledge enters the world through creativity, then undergoes an evolutionary error-correction process until fully formed.',
  ...
  },
  {
    ...
    description:
      "Mathematics reveals patterns that repeat across vastly different phenomena. Feigenbaum discovered how chaotic systems scale universally—his numbers predict when period doubling occurs in everything from fluid dynamics to population growth. Mathematical beauty isn't subjective preference but recognition of deep structure in reality itself.",
  ...
  },
  {
    ...
    description:
      'Formal reasoning provides tools for solving problems within boundaries. Math enables constraint optimization—like cellular networks solving coverage problems through elegant geometric arrangements. Logic supplements perception with systematic methods that work even when intuition misleads.',
  ...
  },
  {
    ...
    description:
      'The law of small numbers misleads by making us draw conclusions from insufficient data. Local patterns can be predictive, but globally, predictions equal actual probabilities only with adequate sample sizes. Mind the sample size of your decision set—it determines what you can validly conclude.',
  ...
  },
  {
    ...
    description:
      "True behavior change only comes when you see yourself differently. Every action you take is a vote on who you want to be. Eventually your identity becomes your habits—you don't just do the behavior, you become the type of person who does that behavior naturally.",
  ...
  },
  {
    ...
    description:
      'The purpose of setting goals is to win the game. The purpose of building systems is to continue playing the game. True long-term thinking is goal-less thinking focused on processes that compound over time rather than one-time achievements.',
  ...
  },
  {
    ...
    description:
      'Rituals create meaning by uniting routine, symbolism, and story into practices that connect individual actions to larger purposes. Moving from implicit to explicit meaning-making requires consciously building ceremonies that reinforce values and create shared identity.',
...
export function getReadwiseModelsByTier(tier: number): MentalModel[] {
  const domainIds = READWISE_DOMAINS.filter(domain => domain.tier === tier).map(
    domain => domain.slug
  );
  return READWISE_MODELS.filter(model => domainIds.includes(model.domainSlug));
}

export function searchReadwiseContent(
  query: string
): Array<Domain | MentalModel> {
